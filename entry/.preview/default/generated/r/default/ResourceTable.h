...
const int32_t STRING_CAMERA_PERMISSION_REASON = 0x0100000a;
const int32_t STRING_MODULE_DESC = 0x01000008;
const int32_t STRING_READ_MEDIA_PERMISSION_REASON = 0x0100000c;
const int32_t STRING_WRITE_MEDIA_PERMISSION_REASON = 0x0100000b;
